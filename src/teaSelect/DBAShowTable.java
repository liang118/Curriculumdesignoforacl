	...
	public void showTable() {
		...
		try {
			while (tableRS.next()) // 循环读取查询结果集中的数据，并逐一添加到二维Vector中
			{
				...
				row.add(tableRS.getString(5));
				row.add(tableRS.getString(6));
				row.add(tableRS.getString(7));
				data.add(row);
			}
...
//			 TODO Auto-generated catch block
		...
		JSP.setBounds(0, contentPane.getHeight()/6,contentPane.getWidth(), contentPane.getHeight());
